...
const qn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.5.12", Fc = "attention-required", Wc = "https://plugins.jetbrains.com/plugin/23758-vaadin", Zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Gc(e) {
...
function Dl() {
  we.push(import("./copilot-log-plugin-DxSeBbhC.js")), we.push(import("./copilot-info-plugin-rHYV3mOw.js")), we.push(import("./copilot-features-plugin-DqvtNecS.js")), we.push(import("./copilot-feedback-plugin-BQlgpzTl.js")), we.push(import("./copilot-shortcuts-plugin-B3hqqkqH.js"));
}
function Tl() {
  {
...
const Tt = new Vl(), A = window.Vaadin.copilot.eventbus;
if (!A)
...
let zr = 1;
function go(e) {
  p.notifications.includes(e) && (e.dontShowAgain && e.dismissId && Ml(e.dismissId), p.removeNotification(e), A.emit("notification-dismissed", e));
}
function bo(e) {
...
function Ul(e) {
  ...
  p.setNotifications([...p.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    go(n);
  }, e.delay ?? Ll), A.emit("notification-shown", e);
}
...
let Yr = class extends Cl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-yK8osKww.js"), await import("./copilot-init-step2-FyQq8bYq.js"), Il(), Dl(), this.tabIndex = 0, Tt.hostConnectedCallback(), window.addEventListener("keydown", Fr), A.onSend(this.handleSendEvent), this.removers.push(A.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
   ...
   */
  async activate() {
    dn("activate"), Tt.activate(), Hr.copilotActivated(), Rl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), nt.onCopilotActivation(), await Ic(), Ao.loadPreviewConfiguration(), this.active = !0;
  }
  /**
